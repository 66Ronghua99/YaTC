...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='./YaTC_datasets/3t1t_pre-training', type=str,
                        help='dataset path')

    parser.add_argument('--output_dir', default='./3t1t_output_dir',
                        help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./3t1t_output_dir',
